...
f = open('./crossfitRegoinals_2015(Clean_Backsquat).csv')
csv_f = csv.reader(f)
...
for i in  itertools.izip(clean_regional_backsquat_weight, clean_regional_competitor_age_int):
    i = (i)
    all_regional_weight.append(i)
    
for i in  itertools.izip(clean_games2015_backsquat_weight, clean_games2015_competitor_age):
    i = (i)
...
xy_chart.render_to_file("CrossfitMaleBackSquat_2015.svg")
