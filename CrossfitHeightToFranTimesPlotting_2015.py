...
for i in  itertools.izip(clean_regional_fran_times_decimal, clean_regional_competitor_height_int):
    i = (i)
    all_regional_times.append(i)
    
for i in  itertools.izip(clean_games2015_fran_times_decimal, clean_games2015_competitor_height):
    i = (i)
...
xy_chart = pygal.XY(stroke=False, show_x_lables=True, x_label_rotation=45, title='Crossfit Regionals Comeptitors vs Crossfit Games Competitors 2015 \n (Height to Fran Time)',
                    x_title='Minutes & Seconds', y_title='Height', dots_size=3)
...
xy_chart.add('Regionals', all_regional_times)
xy_chart.add('Games 2015', all_games2015_times, dot_size=4)
...
xy_chart.render_to_file("CrossfitMaleHeightToFran_2015.svg")
