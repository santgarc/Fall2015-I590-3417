...
for i in  itertools.izip(clean_regional_weight_weight, clean_regional_competitor_height_int):
    i = (i)
    all_regional_weight.append(i)
    
for i in  itertools.izip(clean_games2015_weight_weight, clean_games2015_competitor_height):
    i = (i)
...
xy_chart.render_to_file("CrossfitMaleHeightToWeight_2015.svg")
