...
f = open('./crossfitRegoinals_2015(Clean_Fran).csv')
csv_f = csv.reader(f)
...
for i in  itertools.izip(clean_regional_fran_times_decimal, clean_regional_competitor_age_int):
    i = (i)
    all_regional_times.append(i)
    
for i in  itertools.izip(clean_games2015_fran_times_decimal, clean_games2015_competitor_age):
    i = (i)
...
xy_chart = pygal.XY(stroke=False, show_x_lables=True, x_label_rotation=45, title='Crossfit Regionals Comeptitors vs Crossfit Games Competitors 2015',
                    x_title='Minutes & Seconds', y_title='Age', dots_size=3)
...
xy_chart.render_to_file("CrossfitMaleFran_2015.svg")
