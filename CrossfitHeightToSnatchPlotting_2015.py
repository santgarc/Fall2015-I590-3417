...
for i in  itertools.izip(clean_regional_snatch_weight, clean_regional_competitor_height_int):
    i = (i)
    all_regional_weight.append(i)
    
for i in  itertools.izip(clean_games2015_snatch_weight, clean_games2015_competitor_height):
    i = (i)
...
xy_chart.render_to_file("CrossfitMaleHeightToSnatch_2015.svg")
